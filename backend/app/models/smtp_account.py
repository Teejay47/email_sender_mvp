...
class SMTPAccount(Base):
    ...
    hourly_sent = Column(Integer, nullable=False, default=0)
    ...
    batches = relationship("CampaignBatch", back_populates="smtp_account")
    email_logs = relationship("EmailLog", back_populates="smtp_account", cascade="all, delete-orphan")
